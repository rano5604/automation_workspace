 ...
 *         &lt;element name="attchedDocs" type="{http://bean.license.ws.service.hsdl.soa.tigerit.com/}attachedDoc" maxOccurs="unbounded" minOccurs="0"/>
...
public class Application {
    ...
    @XmlElement(nillable = true)
    protected List<AttachedDoc> attchedDocs;
    @XmlSchemaType(name = "dateTime")
     ...
     * 
     */
    public List<AttachedDoc> getAttchedDocs() {
        if (attchedDocs == null) {
            attchedDocs = new ArrayList<AttachedDoc>();
        }
